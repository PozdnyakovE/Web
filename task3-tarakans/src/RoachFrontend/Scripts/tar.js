...
function get1() {
    ...
    ctx.fillText('Player 1 chose' + ' number  ' + n1 + '  with sum = ' + b1, 30, 20);
}
function get2() {
    var canvas = document.getElementById("map1");
    var ctx = canvas.getContext("2d");
    ...
    ctx.fillText('Player 2 chose' + ' number  ' + n2 + '  with sum = ' + b2, 30, 30);
}
function get3() {
    var canvas = document.getElementById("map1");
    var ctx = canvas.getContext("2d");
    ...
    ctx.fillText('Player 3 chose' + ' number  ' + n3 + '  with sum = ' + b3, 30, 40);
}
function get4() {
    var canvas = document.getElementById("map1");
    var ctx = canvas.getContext("2d");
    ...
    ctx.fillText('Player 4 chose' + ' number  ' + n4 + '  with sum = ' + b4, 30, 50);
}
banks = 0;
function bank() {
    var canvas = document.getElementById("map1");
...
function result() {
    ...
    {   ctx.fillText('Player 1 won with SUM = ' + banks, 10, 10);}
    ...
    {   ctx.fillText('Player 2 won with SUM = ' + banks, 10, 10);}
    ...
    {   ctx.fillText('Player 3 won with SUM = ' + banks, 10, 10);}
    ...
    {   ctx.fillText('Player 4 won with SUM = ' + banks, 10, 10);}
